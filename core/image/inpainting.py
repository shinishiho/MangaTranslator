...
class FluxKontextInpainter:
    ...
    def __init__(
        ...
        Args:
            ...
            backend: "nunchaku", "sdnq", managed "sdcpp", or "sdcpp_remote".
            sdcpp_remote_url: Base URL for an external sd.cpp server.
...
class FluxKleinInpainter:
    ...
    def __init__(
        ...
        Args:
            ...
            backend: "sdnq", managed "sdcpp", or external "sdcpp_remote".
            sdcpp_remote_url: Base URL for an external sd.cpp server.
            sdcpp_cache_mode: sd.cpp cache mode to use when backend is "sdcpp".
            sdcpp_diffusion_quant: Flux sd.cpp diffusion model quant.
